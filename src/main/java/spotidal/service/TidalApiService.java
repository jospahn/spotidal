...
import spotidal.http.ApiException;
import spotidal.http.GsonBodyHandler;
import spotidal.http.RequestLimiter;
import spotidal.model.Token;
import spotidal.model.tidal.DataListResponse;
import spotidal.model.tidal.DataResponse;
import spotidal.model.tidal.Me;
import spotidal.model.tidal.Resource;
...
public class TidalApiService {
    ...
    public TidalApiService(AuthService authService) {
